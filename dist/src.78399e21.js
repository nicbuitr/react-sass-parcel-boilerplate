...
var __dirname = "C:\\Users\\NicoBuitrago\\Downloads\\Web\\react-saas-parcel-boilerplate\\src\\components";
"use strict";
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react.default.createElement("section", {
        className: "header"
      }, _react.default.createElement("h1", null, __dirname.split('\\').reverse()[2].split('-').join(', ').toLocaleUpperCase()));
    }
  }]);
...
},{"react":"../node_modules/react/index.js"}],"api/data.json":[function(require,module,exports) {
module.exports = {
  "_id": 1,
  "names": "Lorem",
  "surnames": "Ipsum",
  ...
  "phone": "555555",
  "work_experiences": [{
    "job_title": "Senior Functional QA Analyst",
    "company": "Lorem Logistics",
    "start_date": "August 2015",
    "end_date": "December 2016",
    "job_description": ["Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, facere officia! Nostrum quis, eos, laborum fugit molestiae omnis enim dolorum necessitatibus saepe iste temporibus quisquam sed quas sapiente eius quae."]
  }, {
    "job_title": "Senior Test Analyst",
    "company": "Ipsum Services",
    "start_date": "June 2015",
    "end_date": "August 2015",
    "job_description": ["Repellendus eligendi atque laborum aliquam corporis laudantium nisi pariatur. Id, eos! Quaerat itaque tempora doloribus repellendus aperiam, nobis ex, aliquid dignissimos accusamus temporibus, facilis est provident nihil reiciendis dolores soluta."]
  }, {
    "job_title": "Senior Programming Analyst",
    "company": "Amet Consulting",
    "start_date": "March 2013",
    "end_date": "October 2014",
    "job_description": ["Cum dolor error ipsum necessitatibus neque et sed incidunt dignissimos est explicabo molestiae, eligendi ad amet enim numquam ea! Aperiam, sequi amet ab nobis hic ex iusto neque? Vero, officiis."]
  }, {
    "job_title": "Base Programmer",
    "company": "Excepturi Consulting",
    "start_date": "October 2012",
    "end_date": "March 2013",
    "job_description": ["Excepturi numquam quod temporibus nobis. Molestias aliquid dicta voluptatem neque molestiae minima nostrum cum eligendi facilis, nesciunt reprehenderit quia consectetur, doloribus ea ut, eaque id modi voluptate. Libero, ut sunt!"]
  }, {
    "job_title": "Programmer",
    "company": "Consequatur Agency",
    "start_date": "January 2011",
    "end_date": "June 2011",
    "job_description": ["Consequatur, assumenda aliquid natus dignissimos totam omnis accusantium alias repellat. Repellat tempora repudiandae praesentium deleniti, nobis aperiam vero animi odio ipsum! Eum incidunt eligendi velit veritatis neque quis unde repellat."]
  }, {
    "job_title": "Software Developer",
    "company": "Quam Private Server",
    "start_date": "December 2009",
    "end_date": "June 2010",
    "job_description": ["Quam iusto atque itaque accusamus laudantium voluptatibus assumenda ipsa culpa autem obcaecati consectetur eveniet, mollitia et placeat saepe sit earum, commodi, repudiandae laboriosam voluptatum suscipit sunt harum? Commodi, voluptates corrupti."]
  }]
};
},{}],"api/jokes.js":[function(require,module,exports) {
"use strict";
...
var jokes = {
  getOne: function getOne() {
    return new Promise(function (resolve, reject) {
      fetch('http://api.icndb.com/jokes/random?escape=javascript').then(function (res) {
        return res.json();
      }).then(function (data) {
...
var _data = _interopRequireDefault(require("../api/data.json"));

var _jokes = require("../api/jokes.js");
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _jokes.jokes.getOne().then(function (jokeReceived) {
    ...
    value: function calculateDuration(dateString2, dateString1) {
      var date1 = new Date(dateString1.split(' ')[0] + ' 1 ' + dateString1.split(' ')[1] + ' 00:00:00');
      var date2 = new Date(dateString2.split(' ')[0] + ' 1 ' + dateString2.split(' ')[1] + ' 00:00:00');
    ...
    value: function renderSearchResults(e) {
      if (e != undefined) {
    ...
    value: function render() {
      ...
      var filteredExperiences = _data.default.work_experiences.filter(function (experience) {
        return experience.job_title.replace(/\s/g, "").toUpperCase().includes(_this3.state.searchString.replace(/\s/g, "").toUpperCase());
      });

      var filteredExpDuration = filteredExperiences.reduce(function (totalDuration, experience) {
        var expDuration = _this3.calculateDuration(experience.end_date, experience.start_date);
      ...
      return _react.default.createElement("section", {
      ...
      }, _react.default.createElement("hr", null), _react.default.createElement("input", {
        type: "text",
        ...
        onChange: this.renderSearchResults.bind(this)
      }), _react.default.createElement("hr", null)), _react.default.createElement("div", {
        className: "app__content"
      }, _react.default.createElement("div", {
        className: "app__joke"
      }, _react.default.createElement("h1", null, "Joke:"), _react.default.createElement("h3", null, this.state.joke)), _react.default.createElement("span", {
        className: "app__experiences"
      }, _react.default.createElement("div", {
        className: "app__exp"
      }, filteredExperiences.map(function (experience, index) {
        return _react.default.createElement("div", {
          key: index
        }, experience.job_title, _react.default.createElement("br", null), " Duration(Months): ", experience.duration);
      })), _react.default.createElement("div", null, "Total duration: ", filteredExpDuration, " Months \u2248 (", (filteredExpDuration / 12).toFixed(1), " Years) "))));
    }
  }]);

  return App;
}(_react.Component); // App.propTypes = {
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","../api/data.json":"api/data.json","../api/jokes.js":"api/jokes.js"}],"../node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {

},{}],"components/Footer.jsx":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(Footer, [{
    key: "render",
    value: function render() {
      var copy = "Nicol\xE1s Buitrago Casta\xF1o";
      return _react.default.createElement("section", {
        className: "footer"
      }, _react.default.createElement("p", {
        className: "footer__copy"
      }, "\xA9 ", new Date().getFullYear(), " ", copy));
    }
  }]);
...
var _default = Footer;
exports.default = _default;
},{"react":"../node_modules/react/index.js","fs":"../node_modules/parcel-bundler/src/builtins/_empty.js"}],"index.jsx":[function(require,module,exports) {
"use strict";
...
_reactDom.default.render(_react.default.createElement(_Header.default, null), document.getElementById('header'));

_reactDom.default.render(_react.default.createElement(_App.default, null), document.getElementById('app'));

_reactDom.default.render(_react.default.createElement(_Footer.default, null), document.getElementById('footer'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./components/Header":"components/Header.jsx","./components/App":"components/App.jsx","./components/Footer":"components/Footer.jsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
